...
export class AdminController {
  ...
  @Post('tasks/pay/:id')
  async payTask(@Param('id') id: string) {
    return this.adminService.payTask(id);
  }

  @Post('tasks/reject/:id')
  async rejectTask(@Param('id') id: string, @Body('reason') reason: string) {
  ...
  async updateCategoryStatus(@Param('id') id: string, @Body('status') status: string) {
  ...
  async updateBoardStatus(@Param('id') id: string, @Body('status') status: string) {
  ...
  @Post('notifications')
  async sendNotification(@Body() body: any, @Req() req: any) {
